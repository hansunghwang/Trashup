...
<c:if test="${sessGrade == '1' || sessGrade == '2'}">
	<div>
		<form name="newRegForm" id="noticeRegForm" class="noticePageStyle noticeRegForm" method="post" action="noticeReg.ad" onsubmit="return RegConfirm()" enctype="multipart/form-data">
			<p>▣ 공지사항</p>
