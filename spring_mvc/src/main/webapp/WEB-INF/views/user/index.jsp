...
<!-- 레이어팝업, 모달창 -->
<form class="loginForm" name="memLogin" method="post" action="/member/loginProc" onsubmit="return pwCheck()">
...
<form name="mainPageCheck" method="post">
	<input type="hidden" name="pageCheck" value="main">
</form>
