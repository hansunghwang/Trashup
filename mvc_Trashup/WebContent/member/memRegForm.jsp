...
<div class="row">
  <div class="card cardReg">	
		...
		<form class="formSet" name="memReg" method="post" action="memRegProc.do#msgPop" onsubmit="return formCheck()">
			<div id="memRegInput">
				<input type="text" name="id" maxlength="20" size="20" placeholder="이메일 계정" onchange="idDoubleCheck('<%=ROOT %>')" required>
...
<script type="text/javascript" src="<%=ROOT %>/JS/idDoubleCheck.js"></script>
